...
namespace YAF.Core
{
    ...
    public class CombinedUserDataHelper : IUserData
    {
        ...
        /// </summary>
        //private SitecoreMembershipUser _SitecoreMembershipUser;
        private SitecoreMembershipUser _SitecoreMembershipUser = null;
        ...
        public bool IsGuest
        {
            get { return _SitecoreMembershipUser.UserName == SitecoreDomainManager.Anonymous; }
        }
        ...
        ///   Gets Membership.
        /// </summary>
        public SitecoreMembershipUser Membership
        {
            get { return _SitecoreMembershipUser; }
        }
        ...
        public string UserName
        {
            get
            {
                if (this.SitecoreMembershipUser != null)
                {
                    return this.SitecoreMembershipUser.UserName;
                }
        ...
        /// </summary>
        protected SitecoreMembershipUser SitecoreMembershipUser
        {
            [SecurityCriticalAttribute]
            get
            {
                if (this._SitecoreMembershipUser == null && this._userId.HasValue)
                {
                    this._SitecoreMembershipUser = UserMembershipHelper.GetMembershipUserById(this._userId.Value);
                }

                return this._SitecoreMembershipUser;
            }
            [SecurityCriticalAttribute]
            set
            {
                this._SitecoreMembershipUser = value;
            }
        }
        ...
        {
            if (this.SitecoreMembershipUser != null && !this._userId.HasValue)
            {
                if (this._userId == null)
                {
                    // get the user id
                    this._userId = UserMembershipHelper.GetUserIDFromProviderUserKey(this.SitecoreMembershipUser.ProviderUserKey);
                }
            }
