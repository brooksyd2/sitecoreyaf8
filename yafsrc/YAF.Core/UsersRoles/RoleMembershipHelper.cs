...
namespace YAF.Core
{
    ...
    public static class RoleMembershipHelper
    {
        ...
        /// </returns>
        public static bool DidCreateForumUser([NotNull] SitecoreMembershipUser user, int pageBoardID)
        {
        ...
        /// The page Board Id.
        /// </param>
        public static void SyncAllSitecoreMembershipUsers(int pageBoardId)
        {
            int totalRecords;
        ...
        /// </returns>
        public static int? UpdateForumUser([NotNull] SitecoreMembershipUser user, int pageBoardID, string[] roles = null)
        {
            if (user == null)
            {
