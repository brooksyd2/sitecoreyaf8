    ...
    public static partial class UserMembershipHelper
    {
        ...
        public static void ApproveAll()
        {
            ...
            while (exitCount > 0)
            {
                ...
                foreach (SitecoreMembershipUser user in allUsers.Cast<SitecoreMembershipUser>().Where(user => !user.IsApproved))
                {
                    // approve this user...
        ...
        public static void DeleteAllUnapproved(DateTime createdCutoff)
        {
            ...
            while (exitCount > 0)
            {
                ...
                // iterate through each one...
                foreach (SitecoreMembershipUser user in
                    allUsers.Cast<SitecoreMembershipUser>().Where(user => !user.IsApproved && user.CreationDate < createdCutoff))
                {
                    // delete this user...
        ...
        /// </returns>
        [SecurityCriticalAttribute]
        public static SitecoreMembershipUser GetMembershipUserById(long? userID)
        {
        ...
        public static SitecoreMembershipUser GetMembershipUserById(int userID, int boardId)
        {
        ...
        /// </returns>
        [SecurityCriticalAttribute]
        public static SitecoreMembershipUser GetMembershipUserByKey(object providerUserKey)
        {
            // convert to provider type...
            return new SitecoreMembershipUser(GetUser(ObjectExtensions.ConvertObjectToType(providerUserKey, Config.ProviderKeyType)));
        }
        ...
        /// </returns>
        [SecurityCriticalAttribute]
        public static SitecoreMembershipUser GetMembershipUserByName(string userName)
        {
        ...
        /// <summary>
        /// Method returns SitecoreMembershipUser 
        /// </summary>
        /// <returns>
        /// Returns SitecoreMembershipUser 
        /// </returns>
        [SecurityCriticalAttribute]
        public static SitecoreMembershipUser GetUser()
        {
        ...
        /// </returns>
        [SecurityCriticalAttribute]
        public static SitecoreMembershipUser GetUser(string username)
        {
        ...
        /// </returns>
        [SecurityCriticalAttribute]
        public static SitecoreMembershipUser GetUser(string username, bool updateOnlineStatus)
        {
            var member = YafContext.Current.Get<MembershipProvider>().GetUser(username, updateOnlineStatus);
            return new SitecoreMembershipUser(member);
        }
        ...
        /// </returns>
        [SecurityCriticalAttribute]
        public static SitecoreMembershipUser GetUser(object providerKey)
        {
            var member = YafContext.Current.Get<MembershipProvider>().GetUser(providerKey, false);
            return new SitecoreMembershipUser(member);
        }
        ...
        /// </returns>
        [SecurityCriticalAttribute]
        public static SitecoreMembershipUser GetUser(object providerKey, bool updateOnlineStatus)
        {
            var member = YafContext.Current.Get<MembershipProvider>().GetUser(providerKey, updateOnlineStatus);
            return new SitecoreMembershipUser(member);
        }

        /// <summary>
        /// Method which returns SitecoreMembershipUser
        /// </summary>
        /// <param name="updateOnlineStatus">if set to <c>true</c> [update online status].</param>
        /// <returns>
        /// Returns SitecoreMembershipUser
        /// </returns>
        [SecurityCriticalAttribute]
        public static SitecoreMembershipUser GetUser(bool updateOnlineStatus)
        {
