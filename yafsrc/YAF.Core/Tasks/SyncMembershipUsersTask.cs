...
namespace YAF.Core.Tasks
{
  ...
  /// </summary>
  public class SyncSitecoreMembershipUsersTask : LongBackgroundTask
  {
    ...
    ///   The _task name.
    /// </summary>
    private const string _taskName = "SyncSitecoreMembershipUsersTask";
    ...
    public static bool Start(int boardId)
    {
      ...
      YafContext.Current.Get<ITaskModuleManager>().StartTask(TaskName, () => new SyncSitecoreMembershipUsersTask { Data = boardId });
