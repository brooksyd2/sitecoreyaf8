...
namespace YAF.Types.SitecoreHelpers
{
    public class SitecoreMembershipUser : MembershipUser
    {
        ...
        public SitecoreMembershipUser([NotNull] MembershipUser innerUser)
            : this(innerUser, innerUser.UserName, innerUser.ProviderName)
        {
        }
        ...
        /// </summary>
        /// <returns>
        /// The <see cref="P:System.Web.Security.SitecoreMembershipUser.UserName"/> for the membership user.
        /// </returns>
        [CanBeNull]
        ...
        public static SitecoreMembershipUser ForumAdmin
        {
            get
            {
                DataTable table = new DataTable();// YAF.Classes.Data.DB.user_list(1, null, null, null, 1);
