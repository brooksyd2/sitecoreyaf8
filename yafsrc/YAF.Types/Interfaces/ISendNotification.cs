...
namespace YAF.Types.Interfaces
{
    ...
    public interface ISendNotification
    {
        ...
        void SendRegistrationNotificationEmail([NotNull] SitecoreMembershipUser user, int userId);
        ...
        /// <param name="user">The user.</param>
        /// <param name="userId">The user id.</param>
        void SendSpamBotNotificationToAdmins([NotNull] SitecoreMembershipUser user, int userId);
        ...
        void SendUserWelcomeNotification([NotNull] SitecoreMembershipUser user, int? userId);
