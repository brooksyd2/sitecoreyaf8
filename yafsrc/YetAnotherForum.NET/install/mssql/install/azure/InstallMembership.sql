...
IF (NOT EXISTS (SELECT name
                FROM sys.objects
                WHERE (name = N'vw_aspnet_SitecoreMembershipUsers')
                  AND (type = 'V')))
BEGIN
  PRINT 'Creating the vw_aspnet_SitecoreMembershipUsers view...'
  EXEC('
  CREATE VIEW [dbo].[vw_aspnet_SitecoreMembershipUsers]
...
GRANT SELECT ON dbo.vw_aspnet_SitecoreMembershipUsers TO aspnet_Membership_ReportingAccess
