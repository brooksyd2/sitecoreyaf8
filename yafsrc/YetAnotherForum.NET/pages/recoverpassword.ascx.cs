...
namespace YAF.Pages
{
    ...
    public partial class recoverpassword : ForumPage
    {
        ...
        {
            SitecoreMembershipUser user = null;
            ...
            if (this.PasswordRecovery1.UserName.Contains("@") && this.Get<MembershipProvider>().RequiresUniqueEmail)
            {
                ...
                if (username != null)
                {
                    user = this.Get<MembershipProvider>().GetUser(username, false).ToType<SitecoreMembershipUser>();
            ...
            else
            {
                ...
                if (this.Get<YafBoardSettings>().EnableDisplayName)
                {
                    ...
                    user = this.Get<MembershipProvider>().GetUser(this.PasswordRecovery1.UserName, false).ToType<SitecoreMembershipUser>();
                }
            }
