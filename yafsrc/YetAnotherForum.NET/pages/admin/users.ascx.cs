...
namespace YAF.Pages.Admin
{
    ...
    public partial class users : AdminPage
    {
        ...
        {
            // start...
            SyncSitecoreMembershipUsersTask.Start(this.PageContext.PageBoardID);
        ...
        protected void UpdateStatusTimer_Tick([NotNull] object sender, [NotNull] EventArgs e)
        {
            ...
            if (this.Get<ITaskModuleManager>().IsTaskRunning(SyncSitecoreMembershipUsersTask.TaskName))
            {
                // continue...
                return;
            }
