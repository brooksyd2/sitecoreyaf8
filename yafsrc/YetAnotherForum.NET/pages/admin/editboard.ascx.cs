    ...
    public partial class editboard : AdminPage
    {
            ...
            bool createUserAndRoles)
        {
            ...
            if (createUserAndRoles)
            {
                ...
                SitecoreMembershipUser newAdmin = this.Get<MembershipProvider>()
                    .CreateUser(
                        adminName,
                        adminPassword,
                        adminEmail,
                        ...
                        true,
                        null,
                        out createStatus).ToType<SitecoreMembershipUser>();
            ...
            {
                // new admin
                SitecoreMembershipUser newAdmin = UserMembershipHelper.GetUser();
